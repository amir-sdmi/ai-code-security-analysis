...
describe('conversion function', () => {
    ...
    test('converts number to hexadecimal and updates the DOM', () => {
        ...
        expect(elements.resultMessage.innerText).toBe('205 converted to hexadecimal is:');
        expect(elements.result.innerText).toBe('CD'); // 205 in hexadecimal format
