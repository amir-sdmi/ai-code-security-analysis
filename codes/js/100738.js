...
describe('conversion function', () => {
    ...
    test('converts number to hexadecimal and updates the DOM', () => {
        ...
        expect(elements.resultMessage.innerText).toBe('409 converted to hexadecimal is:');
        expect(elements.result.innerText).toBe('199'); // 409 in hexadecimal format
