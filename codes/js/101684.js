...
const filter = new Tone.Filter(440, "highpass").toDestination(); //make hipass, connect to output
const minCutoff = 250;
...
ringMod.connect(osc2.frequency); //so connecting this to an oscillator locks its frequency...
...
console.log("oscFreq (X-axis):", oscFreq, "osc2Freq (Y-axis):", osc2Freq, "RM:", lfoFreq, "Cutoff:", cutoff);
}
